...
struct Workbench {
    ...
    const WorkspaceRoot *tools_workspace_root; /* borrowed - App owns it, outlives the Workbench */
...
Workbench *workbench_create(Workspace *workspace, ListenerSystem *listener_system,
                             const WorkspaceRoot *file_workspace_root, const WorkspaceRoot *tools_workspace_root) {
    ...
    workbench->tools_workspace_root = tools_workspace_root;
...
const WorkspaceRoot *workbench_get_tools_workspace_root(const Workbench *workbench) {
    return workbench->tools_workspace_root;
}
